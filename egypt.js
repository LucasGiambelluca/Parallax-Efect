...
window.addEventListener('scroll' ,function(){
    ...
    egypt.style.marginTop = y * 0.7 +"px";
    cloud1.style.marginRight = y * 1.3 +"px";
    cloud2.style.marginLeft = y *1.3 + "px";
    sunref1.style.marginLeft = y*0.9 + 'px';
    sunref1.style.marginTop = y *0.9 + 'px';
